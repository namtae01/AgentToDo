# Salesforce Project: __PROJECT_NAME__
...
## Org aliases
- Default target: `__PRIMARY_ORG_ALIAS__`
- Default Dev Hub: `__DEV_HUB_ALIAS__`
- Production: `__PROD_ORG_ALIAS__` (deploys gated by `.claude/hooks/sf-prod-guard.sh`)
